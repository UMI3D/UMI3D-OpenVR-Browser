...
{
    /// <summary>
    /// Manages the global selection of object (by ray or by proximity).
    /// </summary>
    public class SelectorManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// List of all <see cref="RaySelector"/>.
        /// </summary>
        public List<RaySelector> raySelectors;

        /// <summary>
        /// List of all <see cref="ProximitySelector"/>.
        /// </summary>
        ...
        /// <summary>
        /// Are <see cref="raySelectors"/> activated ?
        /// </summary>
