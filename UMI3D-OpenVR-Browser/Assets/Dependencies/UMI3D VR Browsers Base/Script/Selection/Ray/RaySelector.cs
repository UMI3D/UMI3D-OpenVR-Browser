...
namespace umi3dVRBrowsersBase.selection
{
    ...
    public abstract class RaySelector<T> : RaySelector
    {
        ...
        /// <summary>
        /// Sorts all interactables by their distance and priority.
        /// </summary>
        /// <param name="source"></param>
        /// <returns></returns>
        private RaycastHit[] SortInteractable(RaycastHit[] source)
        {
            var hitsList = new List<RaycastHit>(source);
            var interactables = new List<(RaycastHit, Interactable)>();
            ...
            foreach ((RaycastHit, Interactable) e in interactables)
                res.Add(e.Item1);
