...
[System.Serializable]
public class Vector2RotationInput : AbstractCursorBasedManipulationInput
{

    public override bool IsCompatibleWith(DofGroupEnum dofs)
    {
        return (dofs == DofGroupEnum.RX_RY) || (dofs == DofGroupEnum.RY_RZ) || (dofs == DofGroupEnum.RX_RZ);
    }
